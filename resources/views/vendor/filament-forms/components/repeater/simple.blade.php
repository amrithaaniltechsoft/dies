        ...
        @if (count($items))
            ...
            >
                @foreach ($items as $itemKey => $item)
                    @php
                        $isFirstItem = $itemKey === array_key_first($items);
                        ...
                        $deleteActionIsVisible = $isDeletable && $deleteAction->isVisible() && ! $isFirstItem;
                        ...
                        $reorderActionIsVisible = $isReorderableWithDragAndDrop && $reorderAction->isVisible() && ! $isFirstItem;
                    @endphp
